...
def display_cricket_predictions():
    ...
    selection = st.radio(
        "Select the weather conditions:", ["Sunny☀️", "Overcast⛅", "Drizzle🌦️", "Rain🌧️,"]
    )
    ...
    pitch_condition = st.radio(
        "Select the pitch conditions:", ["Soft", "Dry", "Hard", "Grass"]
    )
...
def main():
    ...
    nav_option = st.sidebar.selectbox(
        "Select Section", ["Homepage", "Cricket Predictions", "Live Cricket Scores"]
    )
